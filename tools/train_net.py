...
# Register Cityscapes detection datasets (clean + all 15 Cityscapes-C corruptions)
        ...
        if cfg.TEST.CONTINUAL_DOMAIN:
            if 'cityscapes' in cfg.DATASETS.TEST[0] and cfg.TEST.EVAL_MATRIX:
                ...
                if comm.is_main_process():
                    import json
                    print("\n[Exp] Metrics:", json.dumps(metrics, indent=2))
                return res
            elif 'coco' in cfg.DATASETS.TEST[0] or 'kitti' in cfg.DATASETS.TEST[0]:
